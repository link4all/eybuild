...
#include <string.h>
#include <eblib.h>
#include "_system_restore_csp.h"

/** GLOBAL **/

static int _system_restore_csp___mime_header(void * __ebfp);

int _system_restore_csp__ (int __calldepth, void * __handle, void * __ebfp)
{
    int __ret = OK;
    char * __page_name = "restore.csp";
    char * __page_path = "/system/";
    char * __page_fullname = "/system/restore.csp";
/** DECLARE **/
...
/** ON_BEGIN **/
    ...
    if (__calldepth==MAX_CALL_DEPTH)
        __ret=_system_restore_csp___mime_header(__ebfp);
    goto_ERROR;
